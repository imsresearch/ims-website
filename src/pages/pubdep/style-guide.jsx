            ...
            <section className="top-section">
                ...
                <div className="preamble-div">
                    ...
                    <p className="preamble">
                        ...
                        <small>
                            Last updated{" "}
                            <time dateTime="2026-09-19T22:32" title="2026-09-19T22:32">
                                2026-09-19 22:32 UTC
                            </time>
                        </small>
                    </p>
                </div>
            ...
            <section className="main-section">
                <main className="main-inner">
                    ...
                    <ul>
                        ...
                        <li><a href="https://journals.plos.org/ploscompbiol/article/figure/image?download&size=large&id=10.1371/journal.pcbi.1005830.g001">This image</a> explains the role of each section</li>
                    </ul>
                    <p>
                        Title
                        <br />
                    ...
                    <ul>
                        <li>Conventions</li>
                        <ul>
                            <li>Any date format may be used, but they should be used consistently.</li>
                            <li>Authors may use American, Commonwealth, or any other formal spelling conventions</li>
                            <li>Always spell out the names for months.</li>
                        </ul>

                        <li>Tone and manner of writing</li>
                        <ul>
                        ...
                        <li>Contractions</li>
                        <ul>
                            <li>Abbreviations and contractions (e.g. ASAP, N/A, can't, they're) should be avoided except for academic abbreviations such as e.g., i.e., and et al.</li>
                            <li>
                        ...
                        <li>Citaitons</li>
                            <ul>
                                ...
                                <br />
                                e.g. Lorem ipsum <sup>a</sup> dolor sit amet...
                                </li>
                                <li>
                                    Numeric citations must be inserted using numbers corresponding to the citation's number in the bibliography in square brackets
                                    <br />
                                    e.g. Lorem ipsum [1] dolor sit amet...
                                    <br />
                                    [1] John Charles, 2026...
                                </li>
                            </ul>
